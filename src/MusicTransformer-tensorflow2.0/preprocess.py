...
from midi_processor.processor import encode_midi, encode_midi_original, decode_midi
...
def preprocess_midi_original(path):
    return encode_midi_original(path)
...
def preprocess_midi_files_under_original(midi_root, save_dir):
