...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='client/admin/v1_7/enterprise/enterprise.proto',
  package='enterprise_1_7',
  syntax='proto3',
  serialized_options=b'Z?github.com/pachyderm/pachyderm/src/client/admin/v1_7/enterprise',
  serialized_pb=b'\n-client/admin/v1_7/enterprise/enterprise.proto\x12\x0e\x65nterprise_1_7\x1a\x1fgoogle/protobuf/timestamp.proto\"X\n\x10\x45nterpriseRecord\x12\x17\n\x0f\x61\x63tivation_code\x18\x01 \x01(\t\x12+\n\x07\x65xpires\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\"8\n\tTokenInfo\x12+\n\x07\x65xpires\x18\x01 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\"W\n\x0f\x41\x63tivateRequest\x12\x17\n\x0f\x61\x63tivation_code\x18\x01 \x01(\t\x12+\n\x07\x65xpires\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\";\n\x10\x41\x63tivateResponse\x12\'\n\x04info\x18\x01 \x01(\x0b\x32\x19.enterprise_1_7.TokenInfo\"\x11\n\x0fGetStateRequest\"a\n\x10GetStateResponse\x12$\n\x05state\x18\x01 \x01(\x0e\x32\x15.enterprise_1_7.State\x12\'\n\x04info\x18\x02 \x01(\x0b\x32\x19.enterprise_1_7.TokenInfo\"\x13\n\x11\x44\x65\x61\x63tivateRequest\"\x14\n\x12\x44\x65\x61\x63tivateResponse**\n\x05State\x12\x08\n\x04NONE\x10\x00\x12\n\n\x06\x41\x43TIVE\x10\x01\x12\x0b\n\x07\x45XPIRED\x10\x02\x32\xfe\x01\n\x03\x41PI\x12O\n\x08\x41\x63tivate\x12\x1f.enterprise_1_7.ActivateRequest\x1a .enterprise_1_7.ActivateResponse\"\x00\x12O\n\x08GetState\x12\x1f.enterprise_1_7.GetStateRequest\x1a .enterprise_1_7.GetStateResponse\"\x00\x12U\n\nDeactivate\x12!.enterprise_1_7.DeactivateRequest\x1a\".enterprise_1_7.DeactivateResponse\"\x00\x42\x41Z?github.com/pachyderm/pachyderm/src/client/admin/v1_7/enterpriseb\x06proto3'
  ,
  dependencies=[google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])

_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='enterprise_1_7.State',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ENTERPRISERECORD = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.EnterpriseRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='activation_code', full_name='enterprise_1_7.EnterpriseRecord.activation_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='expires', full_name='enterprise_1_7.EnterpriseRecord.expires', index=1,
...
_TOKENINFO = _descriptor.Descriptor(
  name='TokenInfo',
  full_name='enterprise_1_7.TokenInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='expires', full_name='enterprise_1_7.TokenInfo.expires', index=0,
...
_ACTIVATEREQUEST = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.ActivateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='activation_code', full_name='enterprise_1_7.ActivateRequest.activation_code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expires', full_name='enterprise_1_7.ActivateRequest.expires', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACTIVATERESPONSE = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.ActivateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='info', full_name='enterprise_1_7.ActivateResponse.info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETSTATEREQUEST = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.GetStateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_GETSTATERESPONSE = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.GetStateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='enterprise_1_7.GetStateResponse.state', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='info', full_name='enterprise_1_7.GetStateResponse.info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEACTIVATEREQUEST = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.DeactivateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_DEACTIVATERESPONSE = _descriptor.Descriptor(
  ...
  full_name='enterprise_1_7.DeactivateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
EnterpriseRecord = _reflection.GeneratedProtocolMessageType('EnterpriseRecord', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.EnterpriseRecord)
  })
...
TokenInfo = _reflection.GeneratedProtocolMessageType('TokenInfo', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.TokenInfo)
  })
...
ActivateRequest = _reflection.GeneratedProtocolMessageType('ActivateRequest', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.ActivateRequest)
  })
...
ActivateResponse = _reflection.GeneratedProtocolMessageType('ActivateResponse', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.ActivateResponse)
  })
...
GetStateRequest = _reflection.GeneratedProtocolMessageType('GetStateRequest', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.GetStateRequest)
  })
...
GetStateResponse = _reflection.GeneratedProtocolMessageType('GetStateResponse', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.GetStateResponse)
  })
...
DeactivateRequest = _reflection.GeneratedProtocolMessageType('DeactivateRequest', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.DeactivateRequest)
  })
...
DeactivateResponse = _reflection.GeneratedProtocolMessageType('DeactivateResponse', (_message.Message,), {
  ...
  '__module__' : 'client.admin.v1_7.enterprise.enterprise_pb2'
  # @@protoc_insertion_point(class_scope:enterprise_1_7.DeactivateResponse)
  })
...
_API = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Activate',
    full_name='enterprise_1_7.API.Activate',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetState',
    full_name='enterprise_1_7.API.GetState',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Deactivate',
    full_name='enterprise_1_7.API.Deactivate',
    index=2,
    containing_service=None,
